...
public class EcoreAdapterFactory extends AdapterFactoryImpl {
	...
	protected EcoreSwitch<Adapter> modelSwitch =
		new EcoreSwitch<Adapter>() {
			@Override
			public Adapter caseECoreCodeGeneration(ECoreCodeGeneration object) {
				return createECoreCodeGenerationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.codegen.ecore.ECoreCodeGeneration <em>ECore Code Generation</em>}'.
	 * <!-- begin-user-doc -->
